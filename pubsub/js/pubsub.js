...
$(document).ready(function () {
  ...
  controllerChannelSwitch = document.getElementById(
    "controller-channel-switch"
  );
  controllerChannelCancel = document.getElementById(
    "controller-channel-cancel"
  );
  controllerChannel = document.getElementById("controller-channel");

  // select the current channel string on focus
  controllerChannel.onmouseup = function () {
    return false;
  };
  ...
  controllerChannel.onkeyup = function (e) {
    if (controllerChannel.value != controllerChannelId) {
      ...
      if (
        controllerChannel.value.length == _idlen &&
        _idpat.test(controllerChannel.value)
      ) {
...
function setupDemo() {
  ...
  publishChannel.onmouseup = function () {
    return false;
  };
